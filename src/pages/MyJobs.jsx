    ...
    <div className="max-w-screen-2xl container mx-auto px-4">
      <div className="my-jobs-container">
        ...
        <div className="p-2 text-center mb-2">
          ...
          <button
            onClick={handleClick}
            className="bg-blue-800 text-white font-semibold px-8 py-2 rounded-md mb-4"
          >
            Search
          </button>
        </div>
            ...
            <div className="rounded-t mb-0 px-4 py-3 border-0">
              <div className="flex flex-wrap items-center">
                ...
                <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                  <button
                    className="bg-blue-800 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
